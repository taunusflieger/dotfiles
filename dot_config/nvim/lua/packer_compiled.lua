...
_G.packer_plugins = {
  ...
  ["django-plus.vim"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/django-plus.vim",
  ...
  ["hydra.nvim"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/hydra.nvim",
  ...
  ["keymap-layer.nvim"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/keymap-layer.nvim",
  ...
  ["python-syntax"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/python-syntax",
  ...
  ["vim-buftabline"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/vim-buftabline",
    url = "https://github.com/ap/vim-buftabline"
  },
  ["vim-devicons"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/vim-devicons",
  ...
  ["vim-python-pep8-indent"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/vim-python-pep8-indent",
  ...
  vimagit = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/vimagit",
